...
class OptimizationOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.optimization ? "Optimization on" : "Optimization off";
	}

}
class BSideOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.bside = !FlxG.save.data.bside;
		if (FlxG.save.data.bside)
			FlxG.save.data.bsidestring = '-b-side';
		else
			FlxG.save.data.bsidestring = '';
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.bside ? "B Side on" : "B Side Off";
	}
